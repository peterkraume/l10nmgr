...
if (TYPO3_MODE == "BE") {
     ...
     */
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addModule('web', 'ConfigurationManager', '', '', [
     ...
     * Registers a Backend Module
     */
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addModule('user', 'txl10nmgrM2', 'top', '', [
