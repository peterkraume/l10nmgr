...
if (TYPO3_MODE == 'BE') {
    ...
    $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['GLOBAL']['cliKeys']['l10nmgr_import'] = [
        'EXT:' . $_EXTKEY . '/Classes/Cli/Import.php',
        '_CLI_user',
    ];
    $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['GLOBAL']['cliKeys']['l10nmgr_export'] = [
...
$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['lowlevel']['cleanerModules']['tx_l10nmgr_index'] = [\Localizationteam\L10nmgr\Index::class];
